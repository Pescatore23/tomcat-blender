...
if __name__ == '__main__':
    ...
    parser.add_argument('-fp', '--footprint', type = int, default = footprint, help = 'radius of the sphere stencel used for the binary opening')
    parser.add_argument('-rs', '--remove_small', type = bool, default=True, help = 'wheter to remove objects smaller than minsize')
    parser.add_argument('-ms', '--minsize', type = int, default=200, help = 'minimum size of connected objects to keep')
